    ...
    return (
      <div>
        <nav class="navbar navbar-expand-lg navbar-light bg-warning">
          <font face="Comic sans MS" size="5"><a class="navbar-brand" href="#">Strong.com</a></font>
          ...
          <button type="button" class="btn btn-primary"><font face="Comic sans MS">
...
<svg xmlns="http://www.w3.org/2000/svg" width="47" height="47" fill="currentColor" class="bi bi-pc-display-horizontal" viewBox="0 0 16 16" id="IconChangeColor"> <path d="M1.5 0A1.5 1.5 0 0 0 0 1.5v7A1.5 1.5 0 0 0 1.5 10H6v1H1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-5v-1h4.5A1.5 1.5 0 0 0 16 8.5v-7A1.5 1.5 0 0 0 14.5 0h-13Zm0 1h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .5-.5ZM12 12.5a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0Zm2 0a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0ZM1.5 12h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1ZM1 14.25a.25.25 0 0 1 .25-.25h5.5a.25.25 0 1 1 0 .5h-5.5a.25.25 0 0 1-.25-.25Z" id="mainIconPathAttribute" fill="#737373"></path> </svg>
              ...
              <li class="nav-item">
                <font face="Comic sans MS" size="4"><a class="nav-link" href="#">Headpones</a></font>
              </li>
              
<svg xmlns="http://www.w3.org/2000/svg" width="47" height="47" fill="currentColor" class="bi bi-headphones" viewBox="0 0 16 16" id="IconChangeColor"> <path d="M8 3a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V8a6 6 0 1 1 12 0v5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1V8a5 5 0 0 0-5-5z" id="mainIconPathAttribute" fill="#737373" stroke-width="0" stroke="#ff0000"></path> </svg>
<li class="nav-item">
<span><font face="Comic sans MS" size="4"><a class="nav-link" href="#"></a></font></span>
             </li> 
             

              <select placeholder='chose your mobile'  className='btn btn-secondary btn-sm dropdown-toggle' name="Mobiles" id="Mobiles">
    <option  value="Iphones"><font font face="Comic sans MS"><a>Iphones</a></font></option>
  <option  value="Xiamis"><font font face="Comic sans MS">Xiaomis</font></option>
  <option  value="Samsungs"><font font face="Comic sans MS">Samsungs</font></option>
  <option  value="Nokias"><font font face="Comic sans MS">Nokias</font></option>
</select>
<button type="button" class="btn btn-primary"><font face="Comic sans MS">
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16" id="IconChangeColor"> <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" id="mainIconPathAttribute"></path> </svg>
</font></button>
              ...
              <li class="nav-item">
              <font face="Comic sans MS" size="4"><a class="nav-link" href="#">Home</a></font>
              
              </li>
              

              <li class="nav-item">
                <a class="nav-link btn btn-primary text-white" type="button" href="#" data-toggle="modal"  data-target="#myModal"><font face="Comic sans MS">Sign In</font></a>
              </li>
              <li class="nav-item">
                <a class="nav-link btn btn-danger text-white" type="button" href="#" data-toggle="modal" data-target="#myModal"><font face="Comic sans MS">Register</font></a>
...
<font face="Comic sans MS" size="4"><span className={this.nrl()}>{this.nrq()}</span></font>
          <a  class="nav-link text-black" href="#"><svg  xmlns="http://www.w3.org/2000/svg" width="47" height="47" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16" id="IconChangeColor"> <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" id="mainIconPathAttribute"></path></svg>
          </a> 
        </nav>
  ...
  nrq(){
    return this.props.p ===0 ? "Kind Of Products:Zero" :"Kind Of Products:"+this.props.p
  }
  nrl(){
    return  this.props.p ===0 ? 'btn btn-primary ' : 'btn btn-success m-2'
  }
}
